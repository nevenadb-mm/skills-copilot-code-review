...
initial_announcements = [
    {
        "title": "Welcome Back to Mergington High!",
        "message": "We're excited to kick off the new semester! Activity sign-ups are now open. "
                   "Browse the list below and register students for their extracurricular interests.",
        "start_date": None,
